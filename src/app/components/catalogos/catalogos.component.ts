...
export class CatalogosComponent {
  ...
  catalogos = [
    ...
    { text: 'Usuarios', icon: 'fa-solid fa-user', href: 'usuarios', style: {'background-color' : '#00000099'}, styleCircle: {'color' : '#00000099'} },
    ...
    { text: 'Proveedores', icon: 'fa-solid fa-people-group', href: 'proveedores', style: {'background-color' : '#BA9400'}, styleCircle: {'color' : '#BA9400'} }
  ];
