...
export class CatalogoCategoriaArticuloListComponent implements OnInit {
  ...
  constructor(private catalogoCategoriaArticuloService: CatalogoCategoriaArticuloService, private router: Router, private loadingService: LoadingService) {
  }
  ...
  ngOnInit(): void {
    this.searchControl.valueChanges
      ...
      .subscribe((value: string | null) => {
        ...
        this.loadCategorias(1, this.pageSize, this.sortField, this.sortDirection, this.searchText);
      });
  ...
  onPageChange(event: any) {
    ...
    this.loadCategorias(this.pageIndex + 1, this.pageSize, this.sortField, this.sortDirection, this.searchText);
  }
